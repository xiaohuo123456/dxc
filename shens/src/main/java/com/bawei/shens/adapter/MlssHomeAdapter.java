...
public class MlssHomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<HomeShopBean.ResultBean.MlssBean.CommodityListBeanXX> list;
    private Context context;

    public MlssHomeAdapter(List<HomeShopBean.ResultBean.MlssBean.CommodityListBeanXX> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.mlss_item_layout, null);
