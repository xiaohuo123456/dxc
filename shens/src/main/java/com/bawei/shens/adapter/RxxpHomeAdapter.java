...
public class RxxpHomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<HomeShopBean.ResultBean.RxxpBean.CommodityListBean> list;
    private Context context;

    public RxxpHomeAdapter(List<HomeShopBean.ResultBean.RxxpBean.CommodityListBean> list, Context context) {
        this.list = list;
