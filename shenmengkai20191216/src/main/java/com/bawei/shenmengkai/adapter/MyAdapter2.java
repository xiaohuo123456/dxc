...
public class MyAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<ShopBean.ResultBean.PzshBean.CommodityListBeanX> listBeanXXES;
    private Context context;

    public MyAdapter2(List<ShopBean.ResultBean.PzshBean.CommodityListBeanX> listBeanXXES, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof Holder){
            ...
            ((Holder) holder).button.setBackgroundColor(Color.RED);
        }
    }
